(function() {
    ...
    function buildBlogItem(item) {
        ...
        item.image ? blogItemTemplate += ` <a href="${item.url}" class="item-blog__image-ibg"><img src="${item.image}" alt="image">\n    </a>` : null;
        blogItemTemplate += `<div class="item-blog__data">${item.data}</div>`;
